const MESSAGES = {
  AUTH: {
    ...
    UNAUTHORIZED: "Unauthorized: No user session found",
    REQUIRED_LOGIN: "Please login",
    BLOCKED_OR_INVALID: "Please login", // reused for blocked/invalid session
...
ORDER: {
  ...
  PLACEMENT_FAILED: "Order failed",
  INVALID_ID: "Invalid Order",
  NOT_FOUND: "Order Not Found",
  LOAD_FAILED: "An error occurred while loading order details",
...
COUPON: {
  ...
  EXPIRED: "Coupon expired or not active",
  MINIMUM_NOT_MET: "Minimum purchase amount not met",
  ALREADY_USED: "Coupon already used",
  LIMIT_EXCEEDED: "Coupon limit exceeded"
},

ORDER: {
    PLACED_SUCCESS: "Order placed successfully! We'll send a confirmation email.",
    PLACED_FAILED: "Order failed. Please try again or contact support.",
...
PRODUCT: {
    ...
    OFFER_ADDED_SUCCESS: "Offer applied successfully",
    OFFER_REMOVED_SUCCESS: "Offer removed successfully",
...
OTP: {
  ...
  RESENT_SUCCESS: "New OTP sent successfully",
